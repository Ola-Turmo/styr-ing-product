  ...
  try {
    ...
    if (action === 'post_match') {
      ...
      const lines = debitBank
        ? [{ accountId: bankAccountId, description: text(transaction.description, 200), debit: amountMinor, credit: 0 }, { accountId: counterAccountId, description: `Avstemming ${text(transaction.external_reference, 120)}`, debit: 0, credit: amountMinor }]
        : [{ accountId: counterAccountId, description: `Avstemming ${text(transaction.external_reference, 120)}`, debit: amountMinor, credit: 0 }, { accountId: bankAccountId, description: text(transaction.description, 200), debit: 0, credit: amountMinor }];
      const statements = [
