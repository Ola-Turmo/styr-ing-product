...
const checks = [
 ...
 ['procurement summary', '/api/procurement?boardId=board-1&view=summary', 200], ['procurement orders', '/api/procurement?boardId=board-1&view=orders', 200], ['procurement receipts', '/api/procurement?boardId=board-1&view=receipts', 200], ['procurement EHF inbox', '/api/procurement?boardId=board-1&view=ehf', 200], ['procurement EHF XML guard', '/api/procurement?boardId=board-1&view=ehf-xml', 400], ['procurement invoices', '/api/procurement?boardId=board-1&view=invoices', 200],
