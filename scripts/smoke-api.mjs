...
const checks = [
 ...
 ['governance summary', '/api/governance?boardId=board-1&view=summary', 200], ['governance contracts', '/api/governance?boardId=board-1&view=contracts', 200], ['governance redlines', '/api/governance?boardId=board-1&view=redlines', 200], ['governance mandates', '/api/governance?boardId=board-1&view=mandates', 200], ['governance equity', '/api/governance?boardId=board-1&view=equity', 200], ['governance grants', '/api/governance?boardId=board-1&view=grants', 200], ['governance equity filings', '/api/governance?boardId=board-1&view=filings', 200],
  ...
  ['payroll people', '/api/payroll?boardId=board-1&view=people', 200], ['payroll setup readiness', '/api/payroll?boardId=board-1&view=readiness', 200],
 ...
 ['procurement summary', '/api/procurement?boardId=board-1&view=summary', 200], ['procurement approval policy', '/api/procurement?boardId=board-1&view=approval-policy', 200], ['supplier register', '/api/procurement?boardId=board-1&view=suppliers', 200], ['procurement orders', '/api/procurement?boardId=board-1&view=orders', 200], ['procurement receipts', '/api/procurement?boardId=board-1&view=receipts', 200], ['procurement EHF inbox', '/api/procurement?boardId=board-1&view=ehf', 200], ['procurement EHF XML guard', '/api/procurement?boardId=board-1&view=ehf-xml', 400], ['procurement invoices', '/api/procurement?boardId=board-1&view=invoices', 200], ['supplier credit notes', '/api/procurement?boardId=board-1&view=credit-notes', 200],
...
for (const [label, path, expected] of checks) {
  ...
  if (label === 'field workspace shell') {
    const html = await response.text();
    if (!html.includes('Timer som kan bli fakturagrunnlag.') || !html.includes('/app/finance') || !html.includes('prepare_invoice')) failures.push(`${label}: expected secondary project-to-accounting bridge`);
  }
