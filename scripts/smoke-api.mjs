...
const checks = [
 ...
 ['governance summary', '/api/governance?boardId=board-1&view=summary', 200], ['governance contracts', '/api/governance?boardId=board-1&view=contracts', 200], ['governance redlines', '/api/governance?boardId=board-1&view=redlines', 200], ['governance mandates', '/api/governance?boardId=board-1&view=mandates', 200], ['governance equity', '/api/governance?boardId=board-1&view=equity', 200], ['governance grants', '/api/governance?boardId=board-1&view=grants', 200], ['governance equity filings', '/api/governance?boardId=board-1&view=filings', 200],
  ...
  ['accounting periods', '/api/finance?boardId=board-1&view=periods', 200], ['MVA summary', '/api/mva?boardId=board-1&view=summary', 200], ['MVA periods', '/api/mva?boardId=board-1&view=periods', 200], ['chart of accounts', '/api/finance?boardId=board-1&view=accounts', 200], ['finance customers', '/api/finance?boardId=board-1&view=customers', 200], ['invoice setup', '/api/finance?boardId=board-1&view=invoice-setup', 200], ['sales invoices', '/api/finance?boardId=board-1&view=invoices', 200], ['recurring invoice templates', '/api/finance?boardId=board-1&view=recurring-templates', 200], ['recurring invoice generations', '/api/finance?boardId=board-1&view=recurring-generations', 200],
 ...
 ['procurement summary', '/api/procurement?boardId=board-1&view=summary', 200], ['supplier register', '/api/procurement?boardId=board-1&view=suppliers', 200], ['procurement orders', '/api/procurement?boardId=board-1&view=orders', 200], ['procurement receipts', '/api/procurement?boardId=board-1&view=receipts', 200], ['procurement EHF inbox', '/api/procurement?boardId=board-1&view=ehf', 200], ['procurement EHF XML guard', '/api/procurement?boardId=board-1&view=ehf-xml', 400], ['procurement invoices', '/api/procurement?boardId=board-1&view=invoices', 200],
