...
const routeContracts = {
  ...
  'functions/api/procurement.ts': ['create_order', 'approve_order', 'purchase_order_not_approved', 'create_receipt', 'create_invoice', 'create_credit_note', 'review_credit_note', 'approve_credit_note', 'supplier_credit_note_exceeds_remaining', 'three_way_match_required', 'approve_invoice', 'requiresHumanApproval', 'payment_reference_conflict', 'idempotent', 'update_supplier', 'supplier_org_number_exists', 'Peppol BIS Billing 3.0', 'line_total_mismatch'],
'functions/api/finance.ts': ['record_invoice_payment', 'payment_reference_conflict', 'period_close_snapshot_stale', 'persistedClosureId', 'reverse_voucher', 'voucher_reversed', 'idempotent', 'paymentReferenceConflict', 'bank_transaction_id IS NULL', 'save_accounting_profile', 'save_customer_invoice_profile', 'invoice-document', 'sales_invoice_documents', 'validNorwegianMod11', 'invoice_number_exists', 'credit_note_number_exists', 'update_account', 'account_type_locked', 'account_in_use', 'voucher_line_count', 'AuditFileVersion>1.30', 'AuditFileCountry>NO', 'SoftwareCompanyName>Styr.ing', 'GroupingCategory>NA', 'AccountType>GL', 'TaxAccountingBasis>A', 'NumberOfEntries>', 'DebitAmount><Amount>', 'CreditAmount><Amount>'],
  ...
  'functions/api/field.ts': ['classify_trip', 'complete_maintenance', 'prepare_invoice', 'approve_time', 'save_rate', 'cost_rate_minor', 'valid_from<=?', 'requiresHumanApproval'],
