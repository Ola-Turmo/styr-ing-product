...
const routeContracts = {
  ...
  'functions/api/procurement.ts': ['create_order', 'approve_order', 'purchase_order_not_approved', 'create_receipt', 'create_invoice', 'three_way_match_required', 'approve_invoice', 'requiresHumanApproval', 'payment_reference_conflict', 'idempotent', 'Peppol BIS Billing 3.0', 'line_total_mismatch'],
  ...
  'functions/api/payroll.ts': ['calculate_compliance', 'prepare_submission', 'payloadHash', 'externalSubmission', 'submission_snapshot_conflict', 'annualSummary', 'statutory_notes', 'idempotent'],
