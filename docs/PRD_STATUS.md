...
- Produksjon verifisert etter deploy med lokal full verifisering, live smoke (123 kontroller) og HTTP-kontroll av landing, `/app/finance/` og produktregister-endepunktet. Preview: `https://4ec59be9.styr-ing.pages.dev`; produksjonsdomene: `https://styr.ing/`. Release commit: `9742588`.
