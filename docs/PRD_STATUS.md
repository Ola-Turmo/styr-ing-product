...
- Produksjon verifisert etter deploy med lokal full verifisering, live smoke (123 kontroller) og HTTP-kontroll av landing, `/app/finance/` og produktregister-endepunktet. Preview: `https://b89f9bf6.styr-ing.pages.dev`; produksjonsdomene: `https://styr.ing/`. Release commit: `e5b2dbc`.
