...
- Produktregisteret kan nå fylle første linje i et nytt fakturautkast via `ProductInvoiceBridge`; brukeren kontrollerer og kan endre linjen før lagring.
- Produksjon verifisert etter deploy med live smoke (123 kontroller) og HTTP-kontroll av `/app/finance/`, produktregister-endepunktet og bridge-markup. Preview: `https://de6d1b12.styr-ing.pages.dev`; produksjonsdomene: `https://styr.ing/`. Release commit: `0d8a918`.
