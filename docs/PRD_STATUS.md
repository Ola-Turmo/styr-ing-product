...
- Kvittering-i-regnskapsflyt-release: lokal verifisering bestått før deploy. Oppgavevelgeren har nå et eget «Last opp kvittering»-startpunkt. Bilagsarkivet kan hente åpne firmakortkjøp, koble valgt kjøp til den opplastede dokument-ID-en og flytte kjøpet til «Til kontroll» i samme SMB-nære arbeidssekvens. Kortutstedelse, OCR og ekstern betaling er fortsatt ikke konfigurert.
