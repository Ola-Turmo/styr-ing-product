...
| Førstegangsoppsett for små virksomheter: kontoplan og åpne perioder | Intern | `AccountingSetupQuick`, `finance.ts` (`seed_smb_chart`, `create_account`, `create_period`), idempotent SMB-grunnoppsett, autorisert skriverolle og audit-logg |
