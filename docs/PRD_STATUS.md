...
- Produksjon verifisert etter deploy med lokal full verifisering, live smoke (123 kontroller) og HTTP-kontroll av landing, `/app/finance/` og produktregister-endepunktet. Preview: `https://1a9b35ae.styr-ing.pages.dev`; produksjonsdomene: `https://styr.ing/`. Release commit: `af2063b`.
